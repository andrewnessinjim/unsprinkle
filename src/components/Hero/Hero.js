  ...
  return (
    <Wrapper>
      <picture>
        ...
        />
        <HeroImage src="/images/hero-img.jpg" alt="An example of the photos you can find on this page - A grey patterned cat staring into the camera with a totally black background"/>
      </picture>
